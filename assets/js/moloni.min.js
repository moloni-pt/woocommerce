...
var Moloni;void 0===(Moloni=void 0===Moloni?{}:Moloni).modals&&(Moloni.modals={}),Moloni.modals.ProductsBulkProcess=async function(s,e,t,o){const i=jQuery,r={create:[],stock:[],update:[]},u=i("#action-modal");var a=u.find(".button-secondary"),d=u.find("#action-modal-spinner");const p=u.find("#action-modal-content");var l=u.find("#action-modal-error"),c=u.find("#action-modal-title-start"),n=u.find("#action-modal-title-end");p.html("").show(),a.hide(),l.hide(),d.show(),c.show(),n.hide();const h=(o,a)=>{o={action:t,ml_product_id:o,wc_product_id:a};return i.ajax({type:"POST",url:ajaxurl,data:o,async:!0})},m=(o,a)=>{o={action:e,ml_product_id:o,wc_product_id:a};return i.ajax({type:"POST",url:ajaxurl,data:o,async:!0})};const f=async()=>{if(s.length){var o=i(s.shift()),a=o.closest(".product__row"),e=a.data("moloniId"),t=a.data("wcId"),d=a.find(".product__row-name").text().trim(),l=a.find(".product__row-reference").text().trim(),c=null,n=null;if(o.hasClass("checkbox_create_product")?(c=m.bind(this,e,t),n="create"):o.hasClass("checkbox_update_stock_product")&&(c=h.bind(this,e,t),n="stock"),c&&n)return o=d+" ("+l+")",p.html("A processar produto: "+o),(e=await c())&&e.valid?(r[n].push(o+": Processado com sucesso"),a.replaceWith(e.product_row)):(r[n].push(o+": Erro no processo"),console.log(e)),u.is(":visible")?f():void 0}};u.modal({fadeDuration:0,escapeClose:!1,clickClose:!1,closeExisting:!0});try{await f();{p.html("");let d=i('<div class="flex flex-col gap-3"></div>'),l=i('<div class="flex flex-col p-2 rounded bg-neutral-40 max-h-44 overflow-auto mt-2" style="display: none"></div>'),c=i('<a class="mt-1" href="#">Clique para ver</a>'),n=i("<div></div>");[{name:"create",label:"processos de criação de produtos."},{name:"update",label:"processos de atualização de produtos."},{name:"stock",label:"processos de atualização de stock."}].forEach(o=>{if(r[o.name].length){let a=l.clone();var e=c.clone(),t=n.clone();r[o.name].forEach(o=>a.append("<div>"+o+"</div>")),e.on("click",function(){a.toggle(200)}),t.append("<div>Concluídos "+r[o.name].length+" "+o.label+"</div>"),t.append(a,e),d.append(t)}}),p.append(d)}d.fadeOut(50)}catch(o){d.fadeOut(50),p.fadeOut(50),l.fadeIn(200),console.log(o)}c.hide(),n.show(),a.show(200),o&&o()};
