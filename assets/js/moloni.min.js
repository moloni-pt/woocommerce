...
var Moloni;void 0===(Moloni=void 0===Moloni?{}:Moloni).MoloniProducts&&(Moloni.MoloniProducts={}),Moloni.MoloniProducts=function(t){function e(){let c=".checkbox_create_product:enabled:checked, .checkbox_update_stock_product:enabled:checked",o=t(".button-start-imports");t(".checkbox_create_product:enabled, .checkbox_update_stock_product:enabled").off("change").on("change",function(){t(c).length?o.removeAttr("disabled"):o.attr("disabled",!0)}).trigger("change"),o.off("click").on("click",function(){let o=[];t(c).each(function(){o.push(t(this))}),o.length&&Moloni.modals.ProductsBulkProcess(o,"toolsCreateWcProduct","toolsUpdateWcStock",e)})}return{init:function(){e()}}}(jQuery);
var Moloni;void 0===(Moloni=void 0===Moloni?{}:Moloni).WcProducts&&(Moloni.WcProducts={}),Moloni.WcProducts=function(t){function e(){let c=".checkbox_create_product:enabled:checked, .checkbox_update_stock_product:enabled:checked",o=t(".button-start-exports");t(".checkbox_create_product:enabled, .checkbox_update_stock_product:enabled").off("change").on("change",function(){t(c).length?o.removeAttr("disabled"):o.attr("disabled",!0)}).trigger("change"),o.off("click").on("click",function(){let o=[];t(c).each(function(){o.push(t(this))}),o.length&&Moloni.modals.ProductsBulkProcess(o,"toolsCreateMoloniProduct","toolsUpdateMoloniStock",e)})}return{init:function(){e()}}}(jQuery);
