...
var Moloni;void 0===(Moloni=void 0===Moloni?{}:Moloni).MoloniProducts&&(Moloni.MoloniProducts={}),Moloni.MoloniProducts=function(t){function o(){t(".import_product").off("click").on("click",function(){var o=t(this).closest(".product__row").data("moloniId");n(),o={action:"toolsCreateWcProduct",ml_product_id:o},t.ajax({type:"POST",url:ajaxurl,data:o,success:i,async:!0})}),t(".import_stock").off("click").on("click",function(){var o=t(this).closest(".product__row").data("moloniId"),c=t(this).closest(".product__row").data("wcId");n(),o={action:"toolsUpdateWcStock",ml_product_id:o,wc_product_id:c},t.ajax({type:"POST",url:ajaxurl,data:o,success:i,async:!0})})}function i(o){o.valid?location.reload():(console.log(o),alert("Ocorreu um erro!"))}function n(){t(".dropdown").addClass("dropdown--disabled")}return{init:function(){o()}}}(jQuery);
var Moloni;void 0===(Moloni=void 0===Moloni?{}:Moloni).WcProducts&&(Moloni.WcProducts={}),Moloni.WcProducts=function(t){function o(){t(".export_product").off("click").on("click",function(){var o=t(this).closest(".product__row").data("wcId");i(),o={action:"toolsCreateMoloniProduct",wc_product_id:o},t.ajax({type:"POST",url:ajaxurl,data:o,success:d,async:!0})}),t(".export_stock").off("click").on("click",function(){var o=t(this).closest(".product__row").data("moloniId"),c=t(this).closest(".product__row").data("wcId");i(),c={action:"toolsUpdateMoloniStock",wc_product_id:c,ml_product_id:o},t.ajax({type:"POST",url:ajaxurl,data:c,success:d,async:!0})})}function d(o){o.valid?location.reload():(console.log(o),alert("Ocorreu um erro!"))}function i(){t(".dropdown").addClass("dropdown--disabled")}return{init:function(){o()}}}(jQuery);
